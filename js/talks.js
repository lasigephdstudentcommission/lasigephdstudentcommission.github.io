...
function showTalksInfo(talks = -1) {
    ...
    switch (talks) {
        ...
        case 15:
            $("#talks_title").text("LASIGE Talks");
            $("#talks_subtitle").text("15th Edition");
            $("#talks_poster").html(`<img width="100%" margin="0" src="assets/img/events/Talks/talks_15.png" alt="... " />`);
            $("#talks_form").text("");
            $("#talks_form").attr("href", "");
            break;
        ...
        case 16:
            $("#talks_title").text("LASIGE Talks");
            $("#talks_subtitle").text("16th Edition");
            $("#talks_poster").html(`<img width="100%" margin="0" src="assets/img/events/Talks/talks_16.png" alt="... " />`);
            $("#talks_form").text("");
            $("#talks_form").attr("href", "");
            break;
        ...
        case 20:
            $("#talks_title").text("LASIGE Talks");
            $("#talks_subtitle").text("20th Edition");
            $("#talks_poster").html(`<img width="100%" margin="0" src="assets/img/events/Talks/talks_20.png" alt="... " />`);
            $("#talks_form").text("");
            $("#talks_form").attr("href", "");
            break;
        ...
        case 21:
            $("#talks_title").text("LASIGE Talks");
            $("#talks_subtitle").text("21st Edition");
            $("#talks_poster").html(`<img width="100%" margin="0" src="assets/img/events/Talks/talks_21.png" alt="... " />`);
            $("#talks_form").text("");
            $("#talks_form").attr("href", "");
            break;
        ...
        case 22:
            $("#talks_title").text("LASIGE Talks");
            $("#talks_subtitle").text("22nd Edition");
            $("#talks_poster").html(`<img width="100%" margin="0" src="assets/img/events/Talks/talks_22.png" alt="... " />`);
            $("#talks_form").text("");
            $("#talks_form").attr("href", "");
            break;
        ...
        case 23:
            $("#talks_title").text("LASIGE Talks");
            $("#talks_subtitle").text("23rd Edition");
            $("#talks_poster").html(`<img width="100%" margin="0" src="assets/img/events/Talks/talks_23.png" alt="... " />`);
            $("#talks_form").text("");
            $("#talks_form").attr("href", "");
            break;
        ...
        case 24:
            $("#talks_title").text("LASIGE Talks");
            $("#talks_subtitle").text("24th Edition");
            $("#talks_poster").html(`<img width="100%" margin="0" src="assets/img/events/Talks/talks_24.png" alt="... " />`);
            $("#talks_form").text("");
            $("#talks_form").attr("href", "");
            break;
        ...
        case 25:
            $("#talks_title").text("LASIGE Talks");
            $("#talks_subtitle").text("25th Edition");
            $("#talks_poster").html(`<img width="100%" margin="0" src="assets/img/events/Talks/talks_25_banner.png" alt="... " />`);
            $("#talks_form").text("");
            $("#talks_form").attr("href", "");
            break;
